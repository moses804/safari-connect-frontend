...
const Home = () => {
  ...
  const features = [
    { icon: '🏨', title: 'Premium Stays', description: 'Curated accommodations for your safari' },
    { icon: '🚌', title: 'Safe Transport', description: 'Reliable and comfortable transportation' },
    { icon: '💰', title: 'Best Prices', description: 'Competitive rates on all bookings' },
    { icon: '🌟', title: 'Great Reviews', description: 'Trusted by thousands of travelers' }
  ];

  if (loading) {
    return <div className="text-center py-20"><div className="inline-block animate-spin text-4xl">⏳</div></div>;
  }
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-xl text-gray-600 mb-8">
              Book accommodations and transportation for unforgettable African safari experiences. Connect with local hosts and drivers for authentic adventures.
            </p>
      ...
      <section className="bg-white py-20 border-t border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center text-gray-900 mb-16">Why Choose SafariConnect?</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, idx) => (
              <div key={idx} className="p-6 bg-gradient-to-br from-gray-50 to-white rounded-lg border border-gray-200 hover:shadow-lg transition">
      ...
      {featuredAccommodations.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <h2 className="text-4xl font-bold text-gray-900 mb-12">Featured Accommodations</h2>
              ...
              <div key={accommodation.id} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition">
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-2xl font-bold text-blue-600">${accommodation.price_per_night}/night</span>
                    <Link
                      to="/accommodations"
      ...
      {featuredTransports.length > 0 && (
        <section className="bg-gray-50 py-20 border-t border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-bold text-gray-900 mb-12">Featured Transports</h2>
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              {featuredTransports.map((transport) => (
                <div key={transport.id} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 mb-4">👥 Capacity: {transport.total_capacity} seats</p>
                    <div className="flex justify-between items-center">
                      <span className="text-2xl font-bold text-green-600">${transport.price_per_day}/day</span>
                      <Link
                        to="/transports"
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-xl mb-8">Join thousands of travelers exploring Africa with SafariConnect</p>
          <Link
            to="/register"
