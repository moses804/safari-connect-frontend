...
const Register = () => {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    try {
      ...
      // Redirect to appropriate dashboard based on role, or to the intended destination
      if (values.role === "tourist") {
        navigate(
          redirectUrl.startsWith("/") ? redirectUrl : "/tourist/dashboard",
        );
      } else if (values.role === "host") {
        navigate(redirectUrl.startsWith("/") ? redirectUrl : "/host/dashboard");
      } else if (values.role === "driver") {
        navigate(
          redirectUrl.startsWith("/") ? redirectUrl : "/driver/dashboard",
        );
      } else {
        navigate(redirectUrl.startsWith("/") ? redirectUrl : "/");
      }
    } catch (error) {
